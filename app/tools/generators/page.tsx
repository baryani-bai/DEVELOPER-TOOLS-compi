...
export const metadata: Metadata = {
  title: 'Code Generators - CodeBox',
  description: 'Generate UUIDs, QR codes, Lorem Ipsum text, CSS gradients, passwords, and more. Free online generator tools for developers.',
  keywords: ['uuid generator', 'qr code generator', 'lorem ipsum', 'css generator', 'password generator'],
}

export default function GeneratorsPage() {
  // Filter tools by category
  const generatorTools = toolRegistry.filter(tool => tool.category === 'generators')
      ...
      <Container>
        ...
        <div className="mb-12">
          <nav className="text-sm font-mono text-text-tertiary mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-text-primary">Generators</span>
          </nav>
          ...
          <p className="text-lg text-text-secondary max-w-3xl">
            Generate UUIDs, QR codes, placeholder text, CSS gradients, secure passwords, random strings, and more. Speed up your development workflow with these essential generator tools.
          </p>

          <div className="mt-6 flex items-center gap-4">
            <div className="px-4 py-2 bg-bg-secondary border border-border-primary">
              <span className="text-2xl font-mono font-bold text-accent-primary">{generatorTools.length}</span>
              <span className="text-sm text-text-tertiary ml-2">generator tools</span>
            </div>
            <div className="px-4 py-2 bg-bg-secondary border border-border-primary">
              <span className="text-sm text-text-tertiary">⚡ Instant Results</span>
            </div>
          </div>
        </div>
